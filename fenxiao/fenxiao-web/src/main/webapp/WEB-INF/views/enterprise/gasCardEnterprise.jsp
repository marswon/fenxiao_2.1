...
<script>
	...
	$(function() {
		$("#enterpriseList")
				.datagrid(
						{
							url : '${ctx}/api/enterprise/getGasCardEnterpriseList',
							nowrap : true,
							striped : true,
							remoteSort : false,
							pageSize : 20,
		...
		$.post('${ctx}/product/getProductPage', {
			...
			if (data.resultCode == 1) {
				if (businessType == 0) {
					...
					$("#tt_gasCard").tree('loadData', data.content);
				}
	...
	function showEditDiscount(id, name, businessTypes) {
		...
		} else if (businessTypes == 3) {
			showEditDiscount_jiayouka(id, name, businessTypes);
		}
	}
	 ...
	 *打开流量折扣配置 弹框
	 */
	function showEditDiscount_jiayouka(id, name, businessType) {
		...
		if (businessType == 3) {
			//加油卡
			businessTypeStr = "加油卡";
			document.getElementById("liuliang_value").style.display = "none";//显示
		//	document.getElementById("liuliang_demo").style.display = "";//显示
			document.getElementById("jiayouka_value").style.display = "";//
		...
		$
				.getJSON(
						...
						function(data) {
							...
							var _li = $('<li style="list-style-type:none;"></li>');
							_li
									.append('<input type="button" style="width:100px;" value="中石化" onclick="searchProduct(\'b\',\''
											+ 4 + '\');"/>');
							_li
									.append('<input type="button" style="width:100px;" value="中石油" onclick="searchProduct(\'b\',\''
											+ 5 + '\');"/>');
							yysType.append(_li);
							//包类型
...
<body>
	<div id="zjjyTabs" class="easyui-tabs" data-options="fit:true">
		<div id="hyTab" title="加油卡合作商" style="padding: 1px">
	...
	<div id="createAcount" style="margin-top: 10px;">
		<form id="createAcountForm" method="post">
			...
			<div style="margin: 20px 0; text-align: center;">
				<a href="#" class="btn btn-primary" onclick="editEnterprise()">保存分配</a>
			</div>
		</form>
	</div>
	<!-- 添加合作商 end -->
	...
	<div id="webinformation1" style="padding: 30px">
		...
		<form id="adminDetail" method="post">
			...
			<table cellpadding="2">
				...
				<tr>
					<td>余额上限：</td>
					<td><input type="text" id="crestValue" name="crestValue" value="0"/>
					</td>
				</tr>
			</table>
			<div
			...
			<div id="order_type_3">
				<table cellpadding="2">
					<tr>
						<td></td>
						<td><button type="button" class='className'
								onclick="openTreeProduct(3)">开通产品包</button></td>
					</tr>
				</table>
				<div class="easyui-panel" style="padding: 5px">
					<ul id="tt_gasCard"></ul>
				...
				<div style="margin: 20px 0;">
					<a href="#" class="btn btn-primary" onclick="edit(3)">保存分配</a>
				</div>
			</div>
			<!-- 加油卡 end-->
	...
	<div id="discountformation" style="margin-top: 10px;">
		<form id="discountDetail" method="post">
			<div class="munt">
				...
				<div
					style="width: 400px; height: 1500px; float: left; background-color: #5cbedd; right: 0">
					...
					<div id="liuliang_value" style="display: none">
						...
						－－－－－－－－－－－－－－－－－－－－－－－－<br /> <input name="flowValue"
							type="checkbox" value="1024003" />&nbsp;&nbsp;1G(24小时包)
					</div>
					<!-- 话费 -->
					<div id="jiayouka_value" style="display: none">
						<table>
							<tr><td>&nbsp;<input name="flowValue" type="checkbox" value="50" />50元&nbsp;&nbsp;&nbsp;&nbsp;</td>
								...
								<td>&nbsp;<input name="flowValue" type="checkbox" value="1000" />1000元&nbsp;&nbsp;&nbsp;&nbsp;</td>
								<td>&nbsp;<input name="flowValue" type="checkbox" value="2000" />2000元&nbsp;&nbsp;&nbsp;&nbsp;</td>
							</tr>
						</table>
					</div>
