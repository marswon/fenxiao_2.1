						...
						function(r) {
							if (r) {
								...
								var endTime = $('#endTime1').datetimebox(
										'getValue');
								var systemStartTime = $('#systemStartTime').datetimebox(
								'getValue');
								var systemEndTime = $('#systemEndTime').datetimebox(
								'getValue');
...
<body>
	...
	<div class="easyui-tabs" data-options="fit:true">
		<div title="流量话费订单管理" style="padding: 2px">
						...
						<tr>
							<td colspan="5">复充状态: <select
								...
								name="search_EQ_fxProduct.provinceId" id="fxProduct_provinceId">
									<option value="">--请选择--</option>
									<option value="000">全国</option></select>
							系统提交时间：<input
											class="easyui-datebox" name="systemStartTime" id="systemStartTime" style="width: 90px">
									<input
											class="easyui-datebox" name="systemEndTime" id="systemEndTime" style="width: 90px">
							</td>
						</tr>
					</table>
				</form>
