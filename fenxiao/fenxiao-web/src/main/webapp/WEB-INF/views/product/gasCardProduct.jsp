...
<script type="text/javascript">
	...
	jQuery(function($) {
		$("#_productList")
				.datagrid(
						{
							url : '${ctx}/product/getGasProductList',
							method : 'get',
							nowrap : false,
							striped : true,
							remoteSort : false,
 ...
 */
	...
	function loadParentAllPacket() {
		$('#productGroup_id').combobox({
			url : "${ctx}/productGroup/getGasFXProductGroup?businessType=3",
			valueField : 'id',
			textField : 'name',
			editable : false,
			width : 130,
	...
	function loadParentPacket() {
		$('#productParentId').combobox({
			url : "${ctx}/productGroup/getAllFXProductGroup?businessType=3",
			valueField : 'id',
			textField : 'name',
			editable : false,
			width : 150,
												...
												'submit',
												{
													...
													onSubmit : function(param) {
														...
														param.proPrice = $(
																...
																.val() * 1000;
														param.flowType = "-1";
														param.yysType = $("#yysId_liuliang").val();
														param.open_proId = open_proId;
														param.save_selfProductType=$("#selfProductType_jiayouka").val();
...
<body>
	<div class="easyui-tabs" data-options="fit:true">
		<div title="加油卡平台产品" style="padding: 2px">
				...
				<form id="queryForm" method="get">
					<table cellpadding="1">
						...
						<td><b>运营商：</b> <select class="sel" name="yysId" id="yysId"
							...
							<td><b>营业类型：</b><select class="sel" id="selfProductType" name="selfProductType" style="width: 80px; padding-left: 0px;">
								<option value="">-请选择-</option>
						...
						<tr>
							<td><div style="float: left; margin-right: 10px;">
									<a href="javascript:;" class="easyui-linkbutton"
										...
										onclick="add_product(0,0);">加油卡产品</a>
								</div></td>
					...
					<div
						...
						<div
							...
							产品组名称:<input name="productParentId" id="productParentId"
								style="margin-top: -5px;"> <span>&nbsp;&nbsp;&nbsp;加油卡名称:</span><input
								type="text" id="savename" name="savename" /> <span>&nbsp;&nbsp;&nbsp;价格:</span><input
								type="text" id="saveprice" name="saveprice"
								style="width: 70px;" />元
								<span>&nbsp;&nbsp;&nbsp;类型:</span><select class="sel" id="selfProductType_jiayouka" style="width:80px">
									<option value="">请选择</option>
									<option value="0">非自营</option>
									<option value="1">自营</option>
								</select>
