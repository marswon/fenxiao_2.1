...
public class ApiShopInterceptor extends HandlerInterceptorAdapter{
	private static Logger logger = LoggerFactory.getLogger(ApiShopInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (!url.matches(exURL)) {
			if (session.getAttribute(Constant.LOGIN_SHOP) == null) {
				logger.warn("还未登录");
