...
public class SHA1Util {
   ...
   public static String hex_sha1(String s) {
    ...
    public static void main(String args[]) {
    	String[] array = new String[] { "814398535", "13377016839", "69", "1" ,"1456469690019","fa661c2ed4f338b82e39ffcb5effd39e"};
        ...
        System.out.println("admin的SHA1的值为：" + hex_sha1("14564696900198143985351337701683969fa661c2ed4f338b82e39ffcb5effd39e1") + ",length=" + hex_sha1("admin").length());
    }
}
