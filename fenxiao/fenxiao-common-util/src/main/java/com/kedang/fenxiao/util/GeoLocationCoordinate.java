...
public class GeoLocationCoordinate {
	public static final double RADIUS_IN_METER = 6371010;
	public static final double RADIUS_IN_KM = 6371.01;
	 ...
	 */
	public static GeoLocationCoordinate fromDegrees(double latitude, double longitude) {
		GeoLocationCoordinate result = new GeoLocationCoordinate();
	 ...
	 */
	public static GeoLocationCoordinate fromRadians(double latitude, double longitude) {
		GeoLocationCoordinate result = new GeoLocationCoordinate();
	...
	/**
	 */
	public static GeoLocationCoordinate fromGeoPoint(GeoPoint point) {
		return fromDegrees(point.getLat(), point.getLng());
	}

	private void checkBounds() {
		if (radLat < MIN_LAT || radLat > MAX_LAT ||
				radLon < MIN_LON || radLon > MAX_LON)
			throw new IllegalArgumentException(radLat + "[" + MIN_LAT + "," + MAX_LAT + "]," 
					                        +  radLon + "[" + MIN_LON + "," + MAX_LON + "]");
	}
	 ...
	 * argument.
	 */
	public double distanceTo(GeoLocationCoordinate location, double radius) {
	 ...
	 * </ul>
	 */
	public GeoLocationCoordinate[] boundingCoordinates(double distance, double radius) {
		...
		return new GeoLocationCoordinate[]{fromRadians(minLat, minLon),
