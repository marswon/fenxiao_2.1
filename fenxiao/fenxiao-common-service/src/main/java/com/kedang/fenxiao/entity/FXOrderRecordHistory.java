...
@Entity
@Table(name = "fx_order_record_history")
@org.hibernate.annotations.Entity(dynamicUpdate = true)
public class FXOrderRecordHistory implements Serializable, Cloneable
{

	/**
	 *
	 */
	private static final long serialVersionUID = 3861211750476554092L;
